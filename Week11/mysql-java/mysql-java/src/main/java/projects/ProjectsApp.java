...
public class ProjectsApp {
  ...
  private void selectProject() {
     ...
     * project because
     * fetchProjectById() will throw an exception if an invalid project ID is
     * entered, which would
   ...
   * projects table.
   * It then uses a Lambda expression to print the project IDs and names on the
   * console.
   */
   ...
   * Prints a prompt on the console and then gets the user's input from the
   * console. If the user
   * enters nothing, {@code null} is returned. Otherwise, the trimmed input is
   * returned.
   * 
   * @param prompt The prompt to print.
